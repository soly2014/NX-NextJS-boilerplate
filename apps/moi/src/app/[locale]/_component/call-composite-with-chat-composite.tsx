...
import { ENDPOINT_URL, MEETING_LINK, TOKEN, USER_ID } from '../page';
/**
 ...
 */
const DISPLAY_NAME = 'Solimna Test ACS';
    ...
    return (
      <div style={{ height: '70vh', display: 'flex' }}>
        <div style={containerStyle}>
          <ChatComposite
            onRenderTypingIndicator={(d: CommunicationParticipant[]): any => {
              return d.map((x) => {
                console.log(x.displayName, 'x.displayName');
